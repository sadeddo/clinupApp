...
const Footer = () => {
  ...
  return (
    ...
    <TouchableOpacity style={styles.footerItem} onPress={() => navigation.navigate('DashboardPresta')}>
          <Icon name="home" size={22} color="#333" />
          <Text style={styles.footerLink}>Dashboard</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.footerItem} onPress={() => navigation.navigate('ReservationsPresta')}>
      ...
      <TouchableOpacity style={styles.footerItem} onPress={() => navigation.navigate('Profil')}>
        <Icon name="user-circle-o" size={22} color="#FF385C" />
